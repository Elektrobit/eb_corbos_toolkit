...
DEF_BUILD_CONTAINER="ghcr.io/elektrobit/eb-corbos-toolkit-buildcontainer-amd64:v7"
DEF_DEV_CONTAINER="ghcr.io/elektrobit/eb-corbos-toolkit-devcontainer-amd64:v7"
