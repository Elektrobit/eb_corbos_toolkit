...
# Currently, skip the relocation step, as it breaks all compiler binaries.
# We likely want to change this later when this is fixed in a newer version
# of the relocation script. The script is created by ISAR.
#bold "Relocate SDK"
...
rm ${FULL_DESTINATION}/relocate-sdk.sh
